...
const Repositories: FC<{}> = (): ReactElement => {
  ...
  const firstRepositoryIndex: number =
    lastRepositoryNumber - repositoriesPerPage;
  ...
  return (
    <section className="resume-section" id="repositories">
      <div className="resume-section-content py-0">
        ...
        <div className="px-0">
          <div>
            {limitedRepositories?.map((repository, key: number) => (
              <RepositoryCard {...repository} key={key} />
            ))}
