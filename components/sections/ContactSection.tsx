        ...
        >
            <div className="text-center max-w-2xl">
                ...
                <p className="text-lg text-secondary mb-12 leading-relaxed">
                    I&apos;m always open to connecting! Whether you have an opportunity to discuss, a question, or just want to say hi, feel free to reach out, and I&apos;ll do my best to get back to you!
                </p>
